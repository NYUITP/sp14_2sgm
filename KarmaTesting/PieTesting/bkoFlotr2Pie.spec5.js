...
describe("Beaker Pie: Invalid R input", function() {
  ...
  beforeEach(inject(function(_outputDisplayFactory_, _outputDisplayService_, $compile, $rootScope) {
    ...
    { 
      type: "TableDisplay", 
      status: "FINISHED",
      columnNames: ["boolean", "food"], 
      values: [ ["true", '%14'] , ["false", ')7'] ]
    };
    ...
    it("check input data error: At least one column should be numeric.", function() {
      ...
      expect(html).toEqual("At least one column should be numeric.");
